...
\usepackage{url}
\usepackage{booktabs}
\title{Mobile Manipulation Spatial Commitments: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about mobile manipulation planning. The original research bet was: Account for spatial commitments that make future manipulation harder after base motion. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item Visually Grounded Task and Motion Planning for Mobile Manipulation (2022)
\item Motion Planning and Cooperative Manipulation for Mobile Robots With Dual Arms (2022)
\item Combined Task and Motion Planning for Mobile Manipulation (2010)
\item Optimal Base Placement and Motion Planning for Mobile Manipulators (2012)
\item Kinodynamic Motion Planning for Collaborative Object Transportation by Multiple Mobile Manipulators (2025)
\end{itemize}
