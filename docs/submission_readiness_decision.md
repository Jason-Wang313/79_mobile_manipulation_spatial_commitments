...
Honest strongest claim: `Account for spatial commitments that make future manipulation harder after base motion.` is a plausible branch-structured mechanism for mobile manipulation planning, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
