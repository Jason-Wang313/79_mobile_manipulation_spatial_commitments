...
This repository contains a hardened, honest workshop-only robotics paper draft for `mobile_manipulation_spatial_commitments`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/79.pdf`
